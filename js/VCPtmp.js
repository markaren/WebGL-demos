...
VCP.Mirror = function (size, renderer, camera, texWidth, texHeight) {
    ...
    this.planeGeo = new THREE.PlaneGeometry(size, size);
    this.mirror = new THREE.Mirror(renderer, camera,
{
    clipBias: 0.003,
    textureWidth: this.texWidth,
    textureHeight: this.texHeight,
    color: 0x777777
});

    this.mirrorMesh = new THREE.Mesh(this.planeGeo, this.mirror.material);
